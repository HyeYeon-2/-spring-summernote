    ...
    var T = "ControlSidebar"
      ...
      , M = function() {
        ...
        return t.collapse = function() {
            ...
            this._config.controlsidebarSlide ? (t.addClass(E),
            e.removeClass(L).delay(300).queue((function() {
                n.default(a).hide(),
                t.removeClass(E),
        ...
        t._init = function() {
            var e = this
              , t = n.default("body");
            t.hasClass(D) || t.hasClass(L) ? (n.default(k).not(this._config.target).hide(),
        ...
        t._fixScrollHeight = function() {
            ...
            if (e.hasClass(A)) {
                ...
                if (0 === o && 0 === i)
                    ...
                    o <= a.header ? !1 === s ? (t.css("top", a.header - o),
                    r.css("height", a.window - (a.header - o))) : t.css("top", a.header) : !1 === s ? (t.css("top", 0),
                    r.css("height", a.window)) : t.css("top", a.header);
                l && s ? (r.css("height", "100%"),
                t.css("height", "")) : (l || s) && (r.css("height", "100%"),
                r.css("height", ""))
            }
        }
        ,
    ...
    var q = "DirectChat"
      ...
      , P = function() {
        ...
        return e.prototype.toggle = function() {
            ...
            n.default(this._element).trigger(n.default.Event("toggled.directchat"))
        }
        ,
        e._jQueryInterface = function(t) {
            return this.each((function() {
    ...
    var ae = "Fullscreen"
      ...
      , re = function() {
        ...
        e._jQueryInterface = function(t) {
            ...
            "string" == typeof t && /toggle|fullscreen|windowed/.test(t) ? o[t]() : o.init()
        }
        ,
        e
    }();
      ...
      , Qe = function() {
        ...
        t.createTab = function(e, t, a, i) {
            var o = this
              , s = "panel-" + a
              , l = "tab-" + a;
            this._config.allowDuplicates && (s += "-" + Math.floor(1e3 * Math.random()),
            ...
            i)
                if (this._config.loadingScreen) {
                    ...
                    n.default(s + " iframe").ready((function() {
                        "number" == typeof o._config.loadingScreen ? (o.switchTab("#" + l),
                        setTimeout((function() {
                            f.fadeOut()
                        }
                        ), o._config.loadingScreen)) : (o.switchTab("#" + l),
                        f.fadeOut())
                    }
                    ))
                } else
        ...
        t.toggleFullscreen = function() {
            n.default("body").hasClass(Se) ? (n.default(ce + " i").removeClass(this._config.iconMinimize).addClass(this._config.iconMaximize),
            n.default("body").removeClass(Se),
            n.default(ye + ", " + Ce).height("auto"),
            n.default(he).height("auto"),
            n.default(ge).height("auto")) : (n.default(ce + " i").removeClass(this._config.iconMaximize).addClass(this._config.iconMinimize),
        ...
        t._init = function() {
            if (window.frameElement && this._config.autoIframeMode)
                ...
                if (n.default(be).children().length > 2) {
                    ...
                    e.show(),
                    this._setItemActive(e.find("iframe").attr("src"))
                }
        ...
        e._jQueryInterface = function(t) {
            ...
            if (a || (a = new e(this,i),
            n.default(this).data(de, a)),
            "string" == typeof t && /createTab|openTabSidebar|switchTab|removeActiveTab/.test(t)) {
    ...
    var He = "lte.layout"
      ...
      , Me = function() {
        ...
        return t.fixLayoutHeight = function(e) {
            ...
            !1 !== s && (o === i.controlSidebar ? l.css(this._config.panelAutoHeightMode, o + s) : o === i.window ? l.css(this._config.panelAutoHeightMode, o + s - i.header - i.footer) : l.css(this._config.panelAutoHeightMode, o + s - i.header),
            this._isFooterFixed() && l.css(this._config.panelAutoHeightMode, parseFloat(l.css(this._config.panelAutoHeightMode)) + i.footer)),
            t.hasClass("layout-fixed") && ("undefined" != typeof n.default.fn.overlayScrollbars ? n.default(De).overlayScrollbars({
                className: this._config.scrollbarTheme,
                sizeAutoCapable: !0,
                scrollbars: {
                    autoHide: this._config.scrollbarAutoHide,
    ...
    var qe = "PushMenu"
      ...
      , Ke = function() {
        ...
        return t.expand = function() {
            ...
            e.addClass(Ve).removeClass("sidebar-collapse sidebar-closed").delay(50).queue((function() {
                e.removeClass(Ve),
                n.default(this).dequeue()
            }
            )),
      ...
      , kt = function() {
        ...
        t._prepareContainer = function() {
            if (0 === n.default(this._getContainerId()).length) {
                ...
                this._config.position == xt ? e.addClass("toasts-top-right") : this._config.position == It ? e.addClass("toasts-top-left") : this._config.position == Tt ? e.addClass("toasts-bottom-right") : this._config.position == jt && e.addClass("toasts-bottom-left"),
